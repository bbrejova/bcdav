...
- V predstihu pred odovzdaním bakalárskej práce
  ...
  - Zálohujte si prácu (napr. vlastný počítač + cloudová služba)
- Do pondelka 18.5. podanie prihlášok na štátne skúšky (AIS)
- Do pondelka 18.5. [odovzdanie práce elektronicky](./Odovzdávanie_prác.html#elektronická-verzia-práce) do systému AIS
- Počas nácviku obhajob [odovzdanie papierovej verzie](./Odovzdávanie_prác.html#odovzdávanie-vytlačených-prác) bakalárskej práce,
- V skúškovom: nácvik obhajob, 40% známky na tomto predmete
   - termíny 8.6. doobeda a poobede, 9.6. doobeda a poobede, 10.6. poobede. Nejaké konflikty? Zapisujte sa od zajtra v AIS
...
* Marek Šugár: Segment focused portfolio optimization based on machine learning predictions, laureát v sekcii Aplikovaná matematika
* Lukáš Gáborik, Jozef Rajník: Constructing flows from flow-pairs, 1-3. miesto v sekcii Teoória grafov a algebra
* Valter Cingel: Uniformné systémy najkratších ciest v grafoch s veľkou grupou automorfizmov, laureát v sekcii Teoória grafov a algebra
* Lucia Ganajová, Marek Šuppa: An English Joke, a Spanish Punchline, and a Slovak Dataset Walk Into a Paper: An Experiment in Pushing the Boundaries of Modern Large Laughing Models, 2. miesto v sekcii Informatika
* Paulína Jaremčuková: Complexity of trained neural networks' decision boundaries, and its relationship with the adversarial robustness, 3. miesto v sekcii Informatika
* Tuan Dávid Nguyen Van: Evaluation Framework for Resource-Constrained Georeferencing Systems on Small Satellites, 1. miesto v sekcii Počítačové videnie a grafika
* Jana Poľašková, Iveta Bečková, Štefan Pócoš: When Neural Networks Fails: An Analysis of Adversarial Examples in Image Classification, 2. miesto v sekcii Počítačové videnie a grafika
* Timotej Šimkovič: Štatistická analýza svetelných kriviek vesmírneho odpadu, laureát v sekcii Počítačové videnie a grafika
...
* Uskutočnilo sa prerokovanie mDAV a mBIN, nevieme výsledky
* Ak budú programy schválené, začneme ich od septembra realizovať a môžete požiadať o prestup z iných programov v rovnakom odbore
